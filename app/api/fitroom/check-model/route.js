// app/api/fitroom/check-model/route.js
...
export async function POST(req) {
    try {
        ...
        out.append("input_image", buf, { filename: "model.jpg", contentType: "image/jpeg" });

        const frResp = await axios.post("https://platform.fitroom.app/api/tryon/input_check/v1/model", out, {
        ...
        console.error("check-model error:", err?.response?.data || err?.message || err);
